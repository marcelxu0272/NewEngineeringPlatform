    ...
    <div className="flex">
      ...
      <div className="fixed left-0 top-0 h-screen w-20 bg-gray-800 p-2 flex flex-col items-center z-10">
        ...
        <div className="flex-1 flex flex-col justify-center space-y-8">
          ...
          >
            <LayoutDashboard className={`w-10 h-10 ${selectedMenu === 'dashboard' ? 'text-white' : 'text-gray-400'}`} />
          </Button>
          <Button
            variant="ghost"
            className="w-16 h-16"
          ...
          >
            <BarChart2 className={`w-10 h-10 ${selectedMenu === 'charts' ? 'text-white' : 'text-gray-400'}`} />
          </Button>
          <Button
            variant="ghost"
            className="w-16 h-16"
          ...
          >
            <Settings className={`w-10 h-10 ${selectedMenu === 'settings' ? 'text-white' : 'text-gray-400'}`} />
          </Button>
        </div>
      </div>
                        ...
                        <div className="flex-grow overflow-hidden">
                          <ResponsiveContainer width="100%" height="100%">
                            <ComposedChart data={chartData}>
                              ...
                              <Tooltip formatter={(value) => formatNumber(Number(value))} />
                              <Legend />
                              <Bar yAxisId="left" dataKey={selectedMetric} name={metrics.find(m => m.id === selectedMetric)?.name} fill="#007069" />
