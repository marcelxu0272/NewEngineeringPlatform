...
import { Line, LineChart, ResponsiveContainer, XAxis, Tooltip as RechartsTooltip, YAxis, CartesianGrid, PieChart, Pie, Cell, Radar, RadarChart, PolarGrid, PolarAngleAxis, PolarRadiusAxis } from "recharts"
...
// 添加雷达图数据
const radarData = [
  { subject: '设计及咨询', A: 85, fullMark: 100 },
  { subject: 'EPC', A: 65, fullMark: 100 },
  { subject: 'PMC', A: 72, fullMark: 100 },
  { subject: '工艺', A: 78, fullMark: 100 },
  { subject: '设备', A: 90, fullMark: 100 },
  { subject: '管道', A: 82, fullMark: 100 },
];
      ...
      <div className="flex min-h-screen">
        ...
        <div className="ml-16 pb-4 space-y-4 bg-[#f8faff] w-[calc(100%-4rem)] min-h-screen overflow-x-hidden">
          ...
          <div className="fixed top-0 left-16 right-0 h-20 bg-white shadow-sm z-20">
            <h2 className="pt-6 pl-6 text-2xl">项目经理看板</h2>
          </div>
