...
import { Search, HelpCircle, Heart, User, Calendar, BarChart2, FileText, Briefcase, Clock, CreditCard, Book, Target, Settings, GitBranch, LogOut, Lock, QrCode, ChevronRight, Edit, Speech, Headset, ChevronLast, ChevronLeft} from 'lucide-react';
...
const HomePage = () => {
  ...
  const handleEngineeringSoftwareSkillsClick = () => {
    router.push('/EngineeringSystemSkills');
  };
          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <Card className="h-[240px]"> {/* 设置固定高度 */}
                ...
                <CardContent className="px-4 py-2 overflow-y-auto h-[220px]"> {/* 设置内容区域可滚动 */}
                ...
                <Tabs value={todoTab} onValueChange={setTodoTab} className="w-full">
                  <TabsList className="grid w-full grid-cols-2 mb-4 relative">
                    <TabsTrigger value="all" className="flex items-center justify-center">
                      所有待办(2)
                      {/* <ChevronRight
                        className="absolute h-4 w-4 text-gray-400 left-36 top-1/2 transform -translate-y-1/2"
                      /> */}
